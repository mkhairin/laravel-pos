                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0">To start a blog, think of a topic about and first brainstorm
                                    party is
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0">The first is a non technical method which requires the use
                                    of adware
                                    removal software. Download free </p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="card-body border-bottom">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0">While most people enjoy casino gambling, sports betting,
                                    lottery and
                                    bingo playing for the fun and </p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="card-body border-bottom">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0">According to the research firm Frost & Sullivan, the
                                    estimated size of
                                    the North American used test</p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="card-body border-bottom">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-4">To start a blog, think of a topic about and first brainstorm party is ways to
                        write
                        details</p>
                    <div id="cash-deposits-chart-legend" class="d-flex justify-content-center pt-3 legend-small">
                    </div>
